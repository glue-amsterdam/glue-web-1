  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        ref={ref}
        className={cn(
          "flex aspect-video justify-center text-xs [&_.recharts-cartesian-axis-tick_text]:fill-muted-foreground [&_.recharts-grid_line]:stroke-border/50 [&_.recharts-tooltip-cursor]:fill-muted [&_.recharts-xAxis_.recharts-cartesian-axis-tick_text]:translate-y-1",
          className,
        )}
        {...props}
      >
