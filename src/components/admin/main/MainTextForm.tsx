...
export type HomeTextFormValues = z.infer<typeof homeTextFormSchema>;

interface MainTextFormProps {
  initialData: HomeTextFormValues;
}

export default function MainTextForm({ initialData }: MainTextFormProps) {
