...
/** Back-to-front: hub layer last so full hubs sit above up-to-three dots at the same coordinates. */
...
/** Registers marker images once per MapView instance; survives exhibitor/route layer swaps. */
export const MapMarkerImagesRegistrar = ({
  colors,
  onReadyChange,
}: {
  colors: MapThemeColors;
  ...
  return (
    <>
      <MapPointPointerCursor
        ...
        enabled={showPointerCursor && markerImagesReady}
      />
      {markerImagesReady && (
